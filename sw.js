...
const stat_files=['voice_recognition.js','index.html','style.css','privacy.html','terms.html','voice_timer.js','stopwatch.js','ru.png','en.png','signal.wav','favicon.svg','manifest.json','maskable_icon.png']

//const stat_files=['/voice_recognition.html']
